...
# (Epic, ID, Name, Terminal, Est Hrs, Actual Hrs, Status, Notes)
rows = [
    ("Epic 0", "0-1", "Turborepo monorepo + shared package scaffold", "Done", 0, 0, "done", "Already shipped"),
    ("Epic 0", "0-2", "Azure infrastructure provisioning", "Done", 0, 0, "done", "Already shipped"),
    ("Epic 0", "0-3", "Database schema + RLS foundation", "Seq (A)", 12, 12, "done", "Sequential blocker — A alone"),
    ("Epic 0", "0-4", "Node.js API foundation + BullMQ", "A", 12, 12, "done", "Completed 2026-04-28"),
    ("Epic 0", "0-5", "Python calculation service scaffold", "A", 8, 8, "done", "Built despite deferral — needed for CI/CD integration (2026-04-28)"),
    ("Epic 0", "0-6", "CI/CD pipeline", "A", 6, 10, "done", "Completed 2026-05-01; complex OIDC + slot-swap wiring"),
    ("Epic 0", "0-7", "Design tokens + minimal component library", "B", 4, None, "backlog", "Tailwind defaults + 3-4 components"),
    ("Epic 0", "0-8", "Accessibility + testing infrastructure", "DEFERRED", 0, None, "deferred", "V2 polish"),
    ("Epic 1", "1-1", "Login API + JWT issuance", "A", 8, None, "backlog", ""),
    ("Epic 1", "1-1b", "Login UI screen", "B", 6, None, "backlog", ""),
    ("Epic 1", "1-2", "Role-based access API guards", "A", 4, None, "backlog", "Auditor + admin roles only"),
    ("Epic 1", "1-2b", "Route guards — frontend", "B", 4, None, "backlog", ""),
    ("Epic 1", "1-3", "Admin user management — auditors", "A+B", 8, None, "backlog", "Simple CRUD + list"),
    ("Epic 1", "1-4", "Admin client management", "DEFERRED", 0, None, "deferred", "No client accounts in MVP"),
    ("Epic 2", "2-1", "Store reference API", "A", 6, None, "backlog", ""),
    ("Epic 2", "2-1b", "Store selector screen", "B", 6, None, "backlog", ""),
    ("Epic 2", "2-2", "Auto-fill + draft creation API", "A", 8, None, "backlog", ""),
    ("Epic 2", "2-2b", "Auto-fill UI", "B", 4, None, "backlog", ""),
    ("Epic 2", "2-3", "Auto-save API endpoints", "A", 6, None, "backlog", ""),
    ("Epic 2", "2-3b", "Auto-save frontend hook", "B", 4, None, "backlog", ""),
    ("Epic 2", "2-4", "Section overview + nav shell", "B", 8, None, "backlog", ""),
    ("Epic 3", "3-1", "Audit breadcrumb + machine room screen", "B", 8, None, "backlog", ""),
    ("Epic 3", "3-2", "Rack entry + duplication", "DEFERRED", 0, None, "deferred", "V2 — single rack in MVP"),
    ("Epic 3", "3-3a", "Compressor + regression API", "A", 10, None, "backlog", "Regression DB lookup"),
    ("Epic 3", "3-3b", "Compressor screens UI", "B", 12, None, "backlog", ""),
    ("Epic 3", "3-4", "Condenser + display case UI + API", "A+B", 14, None, "backlog", "Walk-in coolers deferred"),
    ("Epic 3", "3-5", "Controller systems", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 3", "3-6", "Multi-auditor locking", "DEFERRED", 0, None, "deferred", "Single-auditor MVP"),
    ("Epic 4", "4-1", "Camera + PhotoCaptureField", "B", 12, None, "backlog", ""),
    ("Epic 4", "4-2", "Auto-tag + Azure Blob upload API", "A", 10, None, "backlog", ""),
    ("Epic 4", "4-3", "Additional photos + comments", "B", 6, None, "backlog", ""),
    ("Epic 4", "4-4", "Upload queue retry", "DEFERRED", 0, None, "deferred", "Fail-loud MVP"),
    ("Epic 5", "5-1", "General section screens (minimal)", "B", 6, None, "backlog", ""),
    ("Epic 5", "5-2", "HVAC section", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 5", "5-3", "Lighting + envelope", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 5", "5-4", "Review + submit screen", "B", 8, None, "backlog", ""),
    ("Epic 5", "5-5", "Submission confirmation + email", "A+B", 6, None, "backlog", "SendGrid free tier"),
    ("Epic 6", "6-1", "Store reference seed script", "A", 3, None, "backlog", "SQL seed — no UI"),
    ("Epic 6", "6-2", "Compressor regression seed script", "A", 3, None, "backlog", "SQL seed — no UI"),
    ("Epic 6", "6-3", "Weather data retrieval", "DEFERRED", 0, None, "deferred", "Not needed without baseline"),
    ("Epic 7", "7-1", "Audit queue API + list UI (simple)", "A+B", 6, None, "backlog", "No filters; simple list"),
    ("Epic 7", "7-2", "SLA timer + detail sheet", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 7", "7-3", "State machine transitions", "DEFERRED", 0, None, "deferred", "Simple transitions in MVP"),
    ("Epic 7", "7-4", "Photo lock enforcement", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 8", "8-1", "ECM refrigeration calc", "A", 24, None, "backlog", "Core calc — Node for MVP"),
    ("Epic 8", "8-2", "Energy baseline regression", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 8", "8-3", "LLM anomaly flagging", "DEFERRED", 0, None, "deferred", "V2 — biggest deferred feature"),
    ("Epic 8", "8-4", "Admin flag override", "DEFERRED", 0, None, "deferred", "Needs 8-3"),
    ("Epic 8", "8-5", "Calc inputs/outputs view", "B", 6, None, "backlog", "Basic read-only"),
    ("Epic 9", "9-1", "Puppeteer PDF renderer", "A", 12, None, "backlog", "Self-contained HTML bundle"),
    ("Epic 9", "9-2a", "Admin approve + publish API", "A", 4, None, "backlog", ""),
    ("Epic 9", "9-2b", "Admin approve UI", "B", 4, None, "backlog", ""),
    ("Epic 9", "9-3", "Report immutability / versioning", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 9", "9-4", "Client email on publish", "A", 4, None, "backlog", "SendGrid"),
    ("Epic 9", "9-5", "Report regeneration", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 10", "10-1", "Client portal dashboard", "DEFERRED", 0, None, "deferred", "Email PDF instead"),
    ("Epic 10", "10-2", "Client portal report view", "DEFERRED", 0, None, "deferred", "Email PDF instead"),
    ("Epic 10", "10-3", "Client portal ECM summary", "DEFERRED", 0, None, "deferred", "V2"),
    ("Epic 10", "10-4", "Client portal notifications", "DEFERRED", 0, None, "deferred", "V2"),
]

RATE = 20
start_row = 4
for i, (epic, sid, name, terminal, hrs, actual_hrs, status, notes) in enumerate(rows):
    r = start_row + i
    ...
    c8 = ws_labor.cell(row=r, column=8, value=actual_hrs); c8.number_format = FMT_HRS
...
starter_rows = [
    ...
    # ── Week 2 (Apr 25 – May 2) — status update 2026-05-03 ──────────────
    ("2026-04-25", "Labor", "Story execution", "Self", "Story 0-3 DB schema + RLS — completed (12 hrs est)", None),
    ("2026-04-28", "Labor", "Story execution", "Self", "Story 0-4 Node.js API foundation + BullMQ — completed (12 hrs est)", None),
    ("2026-04-28", "Labor", "Story execution", "Self", "Story 0-5 Python calc service scaffold — completed despite deferral (8 hrs est)", None),
    ("2026-05-01", "Labor", "Story execution", "Self", "Story 0-6 CI/CD pipeline + OIDC/slot-swap — completed (10 hrs actual vs 6 est)", None),
    # ── Subscriptions / Infrastructure ──────────────────────────────────
    ("2026-04-30", "Subscriptions", "Claude Max 20x", "Anthropic", "April subscription cycle", 200),
